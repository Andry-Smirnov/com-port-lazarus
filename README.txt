+-------------------------------------------------+
| ComPort Library version 3.01                    |
| for Delphi 3, 4, 5, 6, 7, 2005                  |
| and C++ Builder 3, 4, 5, 6                      |
|                                                 |
| by Dejan Crnila 1998-2002                       |
| maintained by Lars Dybdahl 2003                 |
| C++ Builder & Delphi2005 support by Paul Doland |
+-------------------------------------------------+
...
Delphi 2005	DsgnCPort9.bpl		CPortLib9.bpl   (also .bdsproj)
...
-----------------------------------------------------------------------------
  ...
  3.) No integrated help for Delphi 2005.
